...
%--------------------------------------------------------------------------
try CUS = DCM.CUSTOM;
    try        M.f = CUS.f;   fprintf('\ncustom state equations %s',CUS.f); end
    try       pE.G = CUS.pE.G;fprintf('\ncustom priors for intrinsics');    end
    try       pC.G = CUS.pC.G;                                              end
    try       pE.T = CUS.pE.T;fprintf('\ncustom priors for time constants\n');end
    try       pC.T = CUS.pC.T;                                              end    
    try       gE.J = CUS.gE.J;fprintf('\ncustom spatial model\n'); end
    try       gC.J = CUS.gC.J;      end
end
...
M.G    = 'spm_lx_erp';
M.IS   = IS;
try M.f; catch M.f    = f; end % choose custom over default
M.h    = h;
M.x    = x;
M.pE   = pE;
M.pC   = pC;
...
% block graphics if requested
try M.nograph = DCM.CUSTOM.nograph; end
